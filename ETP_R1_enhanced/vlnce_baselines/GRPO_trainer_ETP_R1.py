...
class RLTrainer(BaseVLNCETrainer):
    ...
    def _initialize_policy(
        ...
        try:
            ...
            pc_cfg = self.config.MODEL.POINT_CLOUD if hasattr(self.config.MODEL, "POINT_CLOUD") else None
            if pc_cfg is not None and bool(getattr(pc_cfg, "enable_pointnet", False)) and getattr(self.policy.net, "pointnet_encoder", None) is not None:
                self.trainable_parts.append(self.policy.net.pointnet_encoder)
            if pc_cfg is not None and bool(getattr(pc_cfg, "enable_fusion", False)) and getattr(self.policy.net, "pc_feat_proj", None) is not None:
                self.trainable_parts.append(self.policy.net.pc_feat_proj)
