...
# full: legacy behavior (train all parameters). warmup / align: PointCloud SFT stages.
_C.IL.finetune_stage = "full"
# -----------------------------------------------------------------------------
...
_C.MODEL.POINT_CLOUD.enable_spatial_crop = True
_C.MODEL.POINT_CLOUD.max_depth_m = 3.0
_C.MODEL.POINT_CLOUD.num_points = 256
...
_C.MODEL.POINT_CLOUD.enable_learnable_fusion_lambda = True
_C.MODEL.POINT_CLOUD.fusion_lambda_init = 0.5
_C.MODEL.POINT_CLOUD.only_candidate_views = True
_C.MODEL.POINT_CLOUD.accumulate_mode = "mean"
_C.MODEL.POINT_CLOUD.fps_seed = 0
